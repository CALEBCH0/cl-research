...
from torch.nn import Linear, Conv2d, BatchNorm1d, BatchNorm2d, Dropout, MaxPool2d, AdaptiveAvgPool2d
from torch.nn import PReLU, ReLU, ReLU6, Sigmoid
...
class DW_seesawFaceNetv2(Module):
    def __init__(self, embedding_size=512):
        ...
        self.conv1 = Conv_block(1, 96, kernel=(3, 3), stride=(2, 2), padding=(1, 1))
        ...
        self.conv_6_dw = Linear_block(512, 512, groups=512, kernel=(16, 16), stride=(1, 1), padding=(0, 0))  # !#
...
def dwseesawfacev2(embedding_size):
    return DW_seesawFaceNetv2(embedding_size=embedding_size)
